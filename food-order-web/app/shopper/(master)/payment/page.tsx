...
import {
    ...
    PaymentInfoForm,
    PaymentInfoSchema,
    PaymentInfoSearchForm,
    PaymentInfoSearchSchema,
            ...
            <Dialog open={open} onOpenChange={setOpen}>
                <DialogContent>
                    <form onSubmit={editForm.handleSubmit(save)}>
                        <DialogHeader>
                            <DialogTitle>
                                {id == undefined ? "Create" : "Edit"} Payment Information
                            </DialogTitle>
                            <DialogDescription>
                                Add a new payment method with its bank, account, and status details.
                            </DialogDescription>
                        </DialogHeader>
...
function SearchForm({
    ...
    searchForm: PaymentInfoSearchForm
    onAddNew: VoidFunction
    onSearch: (form: PaymentInfoSearchForm) => void
}) {
