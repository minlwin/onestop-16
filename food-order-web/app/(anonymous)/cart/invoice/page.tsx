...
import { Alert01Icon, ArrowRight, ShoppingBasket01Icon } from "@hugeicons/core-free-icons"
...
export default function InvoiceResultPage() {
    ...
    const [invoice] = useFetch(() => (id ? invoiceService.findById(id) : undefined), [id])
