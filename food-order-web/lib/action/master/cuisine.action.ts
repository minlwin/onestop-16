...
import { CuisineListItem, CuisineDetails, CuisineForEdit } from "@/lib/model/output/master-data.model"
...
export async function updateCoverPhoto(id: any, photo: string) : Promise<ModificationResult<number>> {
